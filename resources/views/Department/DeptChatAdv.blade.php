...
<a id="brdcrmbForm:actorHomeCmd"
   ...
   href="#">البوابة الاكاديمية</a><input name="javax.faces.ViewState" id="j_id_id0:javax.faces.ViewState:2"
    ...
    <div>
        <table width="90%" class="box-wrapper0 withShadow" style="font-size:90%;margin: auto" border="0" cellspacing="0"
               cellpadding="0">
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $('.user').click(function () {
                ...
                $.ajax({
                    type: "get",
                    url: "DeptChatAdv/message/" + receiver_id, // need to create this route
                    data: "",
                    cache: false,
            ...
            $(document).on('keyup', '.input-text input', function (e) {
                ...
                if (e.keyCode == 13 && message != '' && receiver_id != '') {
                    ...
                    $.ajax({
                        type: "post",
                        url: "DeptChatAdv/message", // need to create this post route
                        data: datastr,
                        cache: false,
                        success: function (data) {
