   ...
   href="#">البوابة الاكاديمية</a><input name="javax.faces.ViewState" id="j_id_id0:javax.faces.ViewState:2"
    ...
    <div class="site-footer-wrapper" style="margin: auto;width: 90%;">
        ...
        <div id="centered">
            ...
            <div class="SeId box" style="display:none"><strong><input type="text" id="SearchById" onkeyup="SearchById()"
            ...
            @foreach ($Dept_report as $Report)
                ...
                <tr class="ROW1">
                    ...
                    <td>
                        ...
                        <center>&nbsp;{{$Report->Report_File}} <strong  class="card-title" ><a href="{{route('downloadfile_Adv',$Report->Report_Id)}}" class="btn btn-primary">
...
@endif
        ...
        <br>
        <div id="left" style="font-size: 15px">
            <a id="back-buttom"
        ...
        <div id="left0">
            <a id="btnGo"
               href="/Department/DeptCreateAdminReport"> إنشاء تقرير للعمادة </a>

            <a id="btnGo"
               href="/Department/DeptCreateAdvReport"> إنشاء تقرير للمرشد </a>
