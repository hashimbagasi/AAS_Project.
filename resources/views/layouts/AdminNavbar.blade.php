        ...
        <section class="site-logo-wrapper">
            <div class="site-logo" href="#">
                ...
                <div class="headers-wrapper">
                    <a class="header" href="/Administrator/AdminHome"><h1>منظومة الإرشاد الاكاديمي</h1></a>
...
<footer class="site-footer-wrapper">
    ...
    <div class="lower-section">
        <div class="row">
            <section class="copy-right medium-6 small-12 columns">جامعة أم القرى ، تطوير فريق<a>&nbsp; 3xH
                    &nbsp;</a><span></span>
            </section>
