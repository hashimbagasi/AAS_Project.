                                ...
                                <li class="is-submenu-item is-dropdown-submenu-item has-submenu is-dropdown-submenu-parent is-left-arrow opens-left"
                                    ...
                                    <ul class="menu submenu is-dropdown-submenu vertical" role="menu" aria-hidden="true"
                                        ...
                                        <li class="is-submenu-item is-dropdown-submenu-item" role="menuitem">
                                            ...
                                            <script src="{{asset('js/Stu_File/jssf.js')}}"
                                    ...
                                    <ul class="menu submenu is-dropdown-submenu vertical" role="menu" aria-hidden="true"
                                        ...
                                        <li class="is-submenu-item is-dropdown-submenu-item" role="menuitem">
                                            <a id="smallnavmyForm:stdRequestEducationDegreeCmd"
                                               ...
                                               href="#">طلب الالتحاق ببرنامج الاعداد التربوي</a>
                                        </li>
                                    </ul>
                                </li>
                                <li class="is-submenu-item is-dropdown-submenu-item has-submenu is-dropdown-submenu-parent is-left-arrow opens-left"
                                    ...
                                    <ul class="menu submenu is-dropdown-submenu vertical" role="menu" aria-hidden="true"
                                        ...
                                        <li class="is-submenu-item is-dropdown-submenu-item" role="menuitem">
                                            <a id="smallnavmyForm:allowance"
                                               onclick="mojarra.jsfcljs(document.getElementById('smallnavmyForm'),{'smallnavmyForm:allowance':'smallnavmyForm:allowance'},'');return false"
                                               href="#">البدلات</a>
                                        </li>
                                        <li class="is-submenu-item is-dropdown-submenu-item" role="menuitem">
                                            <a id="smallnavmyForm:studPunishCmd"
                                               onclick="mojarra.jsfcljs(document.getElementById('smallnavmyForm'),{'smallnavmyForm:studPunishCmd':'smallnavmyForm:studPunishCmd'},'');return false"
                                               href="#">العقوبات</a>
                                        </li>
                                        <li class="is-submenu-item is-dropdown-submenu-item" role="menuitem">
                                            <a id="smallnavmyForm:studAbsencesCmd"
                                               onclick="mojarra.jsfcljs(document.getElementById('smallnavmyForm'),{'smallnavmyForm:studAbsencesCmd':'smallnavmyForm:studAbsencesCmd'},'');return false"
                                               href="#">الغيابات</a>
                                        </li>
                                        <li class="is-submenu-item is-dropdown-submenu-item" role="menuitem">
                                            <a id="smallnavmyForm:reportsCmd"
                                               onclick="mojarra.jsfcljs(document.getElementById('smallnavmyForm'),{'smallnavmyForm:reportsCmd':'smallnavmyForm:reportsCmd'},'');return false"
                                               href="#">النماذج</a>
                                        </li>
...
{{--                                        <tbody>--}}
{{--                                        <tr>--}}
{{--                                            <td class="Title"><span id="studNoText23">رقم الطالب</span></td>--}}
{{--                                            <td class="text"><span id="studNo23"></span></td>--}}
{{--                                            <td class="Title"><span id="studName23"></span></td>--}}
{{--                                            <td class="text"><span id="studNameText23"></span></td>--}}
{{--                                            <td class="Title"><span id="facName23">الكلية</span></td>--}}
{{--                                            <td class="text"><span id="facNameText23"></span></td>--}}
{{--                                            <td class="Title"><span id="majorNameText23">التخصص</span></td>--}}
{{--                                            <td class="text"><span id="majorName23"></span></td>--}}
{{--                                        </tr>--}}
{{--                                        <tr>--}}
                ...
                <ul class="dropdown menu item user-options-list" role="menubar"
                    ...
                    <li class="has-submenu logged-in is-dropdown-submenu-parent is-down-arrow opens-left"
                        ...
                        <ul class="submenu menu vertical is-dropdown-submenu first-sub" role="menu" aria-hidden="true"
                            data-submenu="">
                            <li class="is-submenu-item is-dropdown-submenu-item" role="menuitem">
                                <a href="../Student/StuProfile">الملف الشخصي</a>
                            </li>
                            <li class="is-submenu-item is-dropdown-submenu-item" role="menuitem">
                    ...
                    <li class="divider" role="menuitem"></li>
                    <li class="has-submenu emailLinks" tabindex="3">
                        <a title="البريد الجامعي" href="https://outlook.com/st.uqu.edu.sa">
...
{{--                            data-submenu="">--}}
{{--                            <li class="is-submenu-item is-dropdown-submenu-item" role="menuitem">--}}
{{--                                <a title="English" class="flag_en" href="https://uqu.edu.sa/en/Sso/App/ACADEMIC_GATE">--}}
{{--                                    <i></i> English </a>--}}
{{--                            </li>--}}
{{--                        </ul>--}}
                    </li>
    ...
    <section id="bottom-bar-wrapper">
        <section class="site-logo-wrapper">
            <div class="site-logo" href="#">
                ...
                <div class="headers-wrapper">
                    <a class="header" href="../Student/StuHome"><h1>منظومة الإرشاد الاكاديمي</h1></a>
        ...
        <nav class="site-navigation-wrapper hide-for-small-only">
            <form name="navmyForm" id="navmyForm" action="/uqu/ui/student/homeIndex.faces"
                  enctype="application/x-www-form-urlencoded" method="post">
                ...
                <div class="dropdown-pane site-navigation-submenu-wrapper" id="example-dropdown-3" aria-hidden="true"
                    ...
                    <ul class="site-navigation-submenu">
                        ...
                        <li class="item">
                            <a id="navmyForm:allowance"
                               onclick="mojarra.jsfcljs(document.getElementById('navmyForm'),{'navmyForm:allowance':'navmyForm:allowance'},'');return false"
                               href="#">البدلات</a>
                        </li>
                        <li class="item">
                            <a id="navmyForm:studPunishCmd"
                               onclick="mojarra.jsfcljs(document.getElementById('navmyForm'),{'navmyForm:studPunishCmd':'navmyForm:studPunishCmd'},'');return false"
                               href="#">العقوبات</a>
                        </li>
                        <li class="item">
                            <a id="navmyForm:studAbsencesCmd"
                               onclick="mojarra.jsfcljs(document.getElementById('navmyForm'),{'navmyForm:studAbsencesCmd':'navmyForm:studAbsencesCmd'},'');return false"
                               href="#">الغيابات</a>
                        </li>
                        <li class="item">
                            <a id="navmyForm:reportsCmd"
                               onclick="mojarra.jsfcljs(document.getElementById('navmyForm'),{'navmyForm:reportsCmd':'navmyForm:reportsCmd'},'');return false"
                               href="#">النماذج</a>
                        </li>
...
<div id="page-content-wrapper">
    ...
    <form name="myForm" id="myForm" action="/uqu/ui/student/homeIndex.faces" enctype="application/x-www-form-urlencoded"
          method="post">
        ...
        <div class="row">
            ...
            <div class="medium-4 columns hide-for-small-only">
                <div class="wrapper">
                    ...
                    <ul class="icons-list">
                        <li>
                            <a class="icon" href="../Student/StuMandatorySurvay" target="_blank">
                                <span class="fa fa-lg fa-google-plus"></span>
                            </a>
{{--                            https://plus.google.com/112690662174328141733--}}
                        </li>
                        <li>
    ...
    <div class="lower-section">
        <div class="row">
            <section class="copy-right medium-6 small-12 columns">جامعة أم القرى ، تطوير فريق<a id="MyTeam">&nbsp; 3xH &nbsp;</a><span></span>
            </section>
